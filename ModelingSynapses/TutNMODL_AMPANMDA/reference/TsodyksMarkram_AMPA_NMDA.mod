...
TITLE AMPA and NMDA glutamate receptor with Tsodyks-Markram dynamics

COMMENT
AMPA and NMDA glutamate receptor conductance using a dual-exponential profile
and with Tsodyks-Markram dynamics of the releasible pool
ENDCOMMENT
...
NET_RECEIVE (weight) {
    ...
    A  = Use * R           : Fraction of release sites which released
    R  = R - Use * R       : Update of the available release sites
